...
export default async function Page ({params} : any) {
    ...
    return (
       <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow">
        <div className="p-8">
            <div className="uppercase tracking-wide text-sm text-indigo-500 font-size-20px">Personal Info </div>
